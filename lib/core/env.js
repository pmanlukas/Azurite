...
class Environment {
    ...
    init(options) {
        ...
        //add my own option here for the logging
        this.silent = options.s || options.silent;
        this.nocyan = options.nc || options.nocyan;
        this.debug = options.d || options.debug;
        this.customDebug = options.cd || options.customDebug;
